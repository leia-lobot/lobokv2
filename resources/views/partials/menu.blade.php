                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @can('my_calendar_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.my-calendars.index") }}" class="nav-link {{ request()->is('admin/my-calendars') || request()->is('admin/my-calendars/*') ? 'active' : '' }}">
                                    <i class="fa-fw fas fa-cogs nav-icon">
                        ...
                        @can('resource_calendar_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.resource-calendars.index") }}" class="nav-link {{ request()->is('admin/resource-calendars') || request()->is('admin/resource-calendars/*') ? 'active' : '' }}">
                                    <i class="fa-fw fas fa-cogs nav-icon">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @can('change_password_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.change-passwords.index") }}" class="nav-link {{ request()->is('admin/change-passwords') || request()->is('admin/change-passwords/*') ? 'active' : '' }}">
                                    <i class="fa-fw fas fa-cogs nav-icon">
