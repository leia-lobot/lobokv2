                    ...
                    <tr data-entry-id="{{ $reservationStatus->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs btn-primary"
                                href="{{ route('admin.reservation-statuses.show', $reservationStatus->id) }}">
                                {{ trans('global.view') }}
                            </a>
                            @endcan
                            ...
                            <a class="btn btn-xs btn-info"
                                href="{{ route('admin.reservation-statuses.edit', $reservationStatus->id) }}">
                                {{ trans('global.edit') }}
                            </a>
                            @endcan

                            @can('reservation_status_delete')
                            <form action="{{ route('admin.reservation-statuses.destroy', $reservationStatus->id) }}"
