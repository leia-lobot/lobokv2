        ...
        <form method="POST" action="{{ route("admin.reservations.update", [$reservation->id]) }}"
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date"
                    id="date" value="{{ old('date', $reservation->date) }}" required>
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text"
                    name="start_time" id="start_time" value="{{ old('start_time', $reservation->start_time) }}"
                    required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('stop_time') ? 'is-invalid' : '' }}" type="text"
                    name="stop_time" id="stop_time" value="{{ old('stop_time', $reservation->stop_time) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('resource') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}"
                        {{ ($reservation->resource ? $reservation->resource->id : old('resource_id')) == $id ? 'selected' : '' }}>
                        {{ $resource }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('company') ? 'is-invalid' : '' }}" name="company_id"
                    ...
                    <option value="{{ $id }}"
                        {{ ($reservation->company ? $reservation->company->id : old('company_id')) == $id ? 'selected' : '' }}>
                        {{ $company }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extras') ? 'is-invalid' : '' }}" type="text" name="extras"
                    id="extras" value="{{ old('extras', $reservation->extras) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status_id" id="status_id" required>
                    @foreach($statuses as $id => $status)
                        <option value="{{ $id }}" {{ ($reservation->status ? $reservation->status->id : old('status_id')) == $id ? 'selected' : '' }}>{{ $status }}</option>
                    @endforeach
                </select>
